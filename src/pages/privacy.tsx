...
export const Privacy = () => {
  ...
  if (status === "authenticated") {
    return (
      <div className="flex flex-grow flex-col gap-6 overflow-y-auto bg-slate-100 px-16 dark:bg-slate-900">
        <p className="">
          <h1 className="text-xl font-bold">Privacy Policy</h1>
          <br />
          <p>
            This Privacy Policy describes how we collect, use, and disclose your
            personal information when you use our website/application
            ("Service"). By using the Service, you consent to the collection,
          ...
          <p className="pb-2">
            1. We may collect the following personal information from you when
            you use the Service:
          </p>
          <ul className="ml-8 list-disc">
            <li>
              Information related to your use of the Service, such as IP
              address, browser type, and device type.
            </li>
          </ul>
          <br />
