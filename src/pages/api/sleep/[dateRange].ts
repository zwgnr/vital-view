  ...
  switch (dateRange) {
    ...
    case "thisYear":
      return res.status(200).json({
        ...
        rangeAverage: {
          hrv: getYearlyRangeAverage(getRange(dateRange, data), "average_hrv"),
    ...
    default:
      return res.status(200).json({
        ...
        rangeAverage: {
          ...
          efficiency: getRangeAverage(getRange(dateRange, data), "efficiency"),
          restingHeartRate: getRangeAverage(
            getRange(dateRange, data),
            "lowest_heart_rate"
          ),
          duration: getAverageDuration(dateRange, data, "total_sleep_duration"),
          ...
          deepSleep: getAverageDuration(dateRange, data, "deep_sleep_duration"),
        },
        percentChange: {
