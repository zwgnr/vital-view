...
export const TodaysScores = () => {
  ...
  return (
    <div className="h-2/3 w-full rounded-xl bg-white dark:bg-slate-700  sm:h-1/3">
      <h1 className="text-md ml-4 mt-4 font-bold">Todays Scores</h1>
      <div className=" flex h-[90%] min-h-0 w-full flex-col rounded-xl dark:bg-slate-700 sm:flex-row">
